...
<div class="easyui-panel" title="添加书籍页面" iconCls="icon-add" fit="true" >
	    ...
	    <form id="add-form" method="post">
	    	<table cellpadding="5">
	    		<tr>
	    			<td>书籍名称:</td>
	    			<td><input class="wu-text easyui-textbox easyui-validatebox" type="text" name="title" data-options="required:true,missingMessage:'请填写书籍标题'"></input></td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
	    			<td>介绍:</td>
	    			<td>
	    				<textarea name="abstrs" rows="6" class="wu-textarea easyui-validatebox" style="width:260px" data-options="required:true,missingMessage:'请填写书籍摘要'"></textarea>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>书籍标签:</td>
	    			<td><input class="wu-text easyui-textbox easyui-validatebox" type="text" name="tags" data-options="required:true,missingMessage:'请填写书籍标签'"></input></td>
	    		</tr>
	    		<tr>
	    			<td>书籍封面:</td>
	    			<td>
	    				<input class="wu-text easyui-textbox easyui-validatebox" type="text" id="add-photo" name="photo" readonly="readonly" value="/Book/resources/upload/book-pic.jpg" data-options="required:true,missingMessage:'请上传封面'"></input>
	    		...
	    		<tr>
	    			<td>书籍作者:</td>
	    			<td><input class="wu-text easyui-textbox easyui-validatebox" type="text" name="author" data-options="required:true,missingMessage:'请填写书籍作者'"></input></td>
	    		</tr>
	    		<tr>
	    			<td>书籍介绍:</td>
	    			<td>
...
<div id="preview-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:330px; padding:10px;">
        <table>
            <tr>
                <td><img id="preview-photo" src="/Book/resources/upload/book-pic.jpg" width="300px"></td>
            </tr>
        </table>
</div>
<!-- 上传图片进度条 -->
