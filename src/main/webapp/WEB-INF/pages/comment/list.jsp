...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
	                <td width="60" align="right">评论书籍:</td>
	                <td>
	                	<select name="bookId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择要评论的书籍'">
	...
	<form id="edit-form" method="post">
        ...
        <table>
             <tr>
	                <td width="60" align="right">评论书籍:</td>
	                <td>
	                	<select id="edit-bookId" name="bookId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择要评论的书籍'">
			                <c:forEach items="${bookList }" var="book">
			                <option value="${book.id }">${book.title }</option>
			                </c:forEach>
			            </select>
	...
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-bookId").combobox('setValue',item.bookId);
            }
        });
	}	
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'bookId',title:'评论书籍',width:100,formatter:function(value,row,index){
