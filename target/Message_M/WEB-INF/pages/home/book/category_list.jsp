...
<div class="content" id="book-list">
  ...
  <article class="excerpt excerpt-1" style="">
		...
		<header>
			<a class="cat" href="../book/category_list?cid=${book.categoryId }" title="${book.bookCategory.name }" >${book.bookCategory.name }<i></i></a>
...
$(document).ready(function(){
	$("#load-more-btn").click(function(){
		...
		$.ajax({
			url:'../book/get_category_list',
			type:'post',
			data:{rows:10,page:page++,cid:'${bookCategory.id}'},
			dataType:'json',
