...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#574c5a;text-align :center;padding-top:6%;">
    <img src="../resources/admin/easyui/images/load.gif" width="50%">
</div>

<div class="wu-header" data-options="region:'north',border:false,split:true" style="background-color: #574c5a">
    <div class="wu-header-left">
        <h1>分享书屋后台管理系统</h1>
    </div>
    <div class="wu-header-right">
        <p><strong class="easyui-tooltip">${role.name}:${admin.username}</strong>，欢迎您！</p>
        <p><a href="../index/index">网站首页</a>|<a href="logout">安全退出</a></p>
    </div>
</div>
...
<div class="wu-main" data-options="region:'center'">
    <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">
        <div title="欢迎页面" data-options="href:'welcome',closable:false,iconCls:'icon-tip',cls:'pd3'"></div>
    </div>
</div>
<!-- end of main -->
<!-- begin of footer -->
