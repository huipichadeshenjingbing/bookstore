...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>书籍标题:</label><input id="search-title" class="wu-text" style="width:100px">
            <label>书籍作者:</label><input id="search-author" class="wu-text" style="width:100px">
            <label>书籍分类:</label>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'title',title:'书名',width:300,formatter:function(value,row,index){
				return '<a href="../../book/detail?id='+row.id+'" target="_blank">' + value + '</a>';
			}},
